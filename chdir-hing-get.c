...
/**
* cd_to - Handles the 'cd' command to change to a specified directory.
*
* @datash: Data structure containing shell information.
* Return: None.
*/
...
/**
* cd_previous - Handles the 'cd -' command to change to the previous directory.
*
* @datash: Data structure containing shell information.
* Return: None.
*/
...
/**
* cd_to_home - Handles the 'cd' command to change to the user's home directory.
* @datash: Data structure containing shell information.
* Return: None.
*/
