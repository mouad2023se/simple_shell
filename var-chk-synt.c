...
/**
* repeated_char - Count the number of repeated characters in a row.
* @input: Input string.
...
* Return: Index where the error occurs (if any).
*/
...
* Return: 0 if a non-separator character is found, -1 otherwise.
*/
...
* @input: Input string.
* @i: Index where the error occurs.
* @bool: Direction to determine the source of the error.
*/
